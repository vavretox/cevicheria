                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="stock" class="form-control" id="stockInput"
                                   min="0" value="<?php echo e(old('stock', $product->stock)); ?>" required>
                            <small class="text-muted" id="stockHelp">
                                <?php echo e(old('unlimited_stock', $product->unlimited_stock) ? 'Este producto no descontará stock al venderse.' : 'Ingresa la cantidad disponible.'); ?>
                        ...
                        <div class="col-md-4 mb-3" id="unlimitedStockWrapper">
                            ...
                            <div class="form-check mt-2">
                                ...
                                <input type="checkbox" name="unlimited_stock" value="1" class="form-check-input" id="unlimitedStockCheckbox"
                                       <?php echo e(old('unlimited_stock', $product->unlimited_stock) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="active" class="form-select">
                                <option value="1" <?php echo e($product->active ? 'selected' : ''); ?>>Activo</option>
                                <option value="0" <?php echo e(!$product->active ? 'selected' : ''); ?>>Inactivo</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e($product->image_url); ?>" class="image-preview" id="currentImage">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/cevicheria-pos/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>