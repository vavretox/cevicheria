...
<?php $__env->startSection('title', 'Procesar Pedido'); ?>
...
<div class="mb-4">
    <a href="<?php echo e(route('cashier.dashboard')); ?>" class="btn btn-outline-secondary mb-3">
        <i class="fas fa-arrow-left me-2"></i>Volver
    </a>
    <h2><i class="fas fa-receipt me-2"></i>Pedido #<?php echo e($order->display_number); ?></h2>
    <div class="mt-2">
...
<div class="row">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <?php if($order->status === 'pending'): ?>
                            <div class="table-transfer-card mb-3">
                                ...
                                <select class="form-select form-select-sm" id="editTableSelect">
                                    <?php $__currentLoopData = $selectableTables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($table->id); ?>" <?php echo e($order->table_id === $table->id ? 'selected' : ''); ?>>
                                            <?php echo e($table->name); ?><?php echo e(!$table->active ? ' (cerrada)' : ''); ?>
                            ...
                            <div class="mb-2">
                                ...
                                <select class="form-select form-select-sm" id="editWaiter">
                                    <?php $__currentLoopData = $waiters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($waiter->id); ?>" <?php echo e($order->user_id === $waiter->id ? 'selected' : ''); ?>>
                        ...
                        <?php else: ?>
                            <p><strong>Mesa:</strong> <?php echo e($order->table_number); ?></p>
                            <p><strong>Mesero:</strong> <?php echo e($order->user->name); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Fecha:</strong> <?php echo e($order->created_at->format('d/m/Y')); ?></p>
                        <p><strong>Hora:</strong> <?php echo e($order->created_at->format('H:i:s')); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr data-item-key="detail-<?php echo e($detail->id); ?>" data-product-id="<?php echo e($detail->product_id); ?>">
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <?php if($detail->notes): ?>
                                            <br><small class="text-muted">Nota: <?php echo e($detail->notes); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="align-middle">
                                    <?php if($order->status === 'pending'): ?>
                                        <select class="form-select form-select-sm service-type-input" data-item-key="detail-<?php echo e($detail->id); ?>">
                                            <option value="dine_in" <?php echo e($detail->service_type === 'dine_in' ? 'selected' : ''); ?>>En mesa</option>
                                            <option value="takeaway" <?php echo e($detail->service_type === 'takeaway' ? 'selected' : ''); ?>>Para llevar</option>
                                        </select>
                                    <?php else: ?>
                                        <span class="badge <?php echo e($detail->service_type === 'takeaway' ? 'bg-warning text-dark' : 'bg-secondary'); ?>"><?php echo e($detail->service_type_label); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center align-middle">
                                    <?php if($order->status === 'pending'): ?>
                                        <input type="number" class="form-control form-control-sm text-center qty-input"
                                               min="0" value="<?php echo e($detail->quantity); ?>"
                                               data-item-key="detail-<?php echo e($detail->id); ?>">
                                    <?php else: ?>
                                        <span class="badge bg-primary fs-6"><?php echo e($detail->quantity); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-end align-middle">
                                    <?php if($order->status === 'pending'): ?>
                                        <input type="number" min="0" step="0.01" class="form-control form-control-sm text-end price-input"
                                               value="<?php echo e(number_format($detail->unit_price, 2, '.', '')); ?>"
                                               data-item-key="detail-<?php echo e($detail->id); ?>">
                                    <?php else: ?>
                                        Bs. <?php echo e(number_format($detail->unit_price, 2)); ?>

                                    <?php endif; ?>
                                </td>
                                <td class="text-end align-middle">
                                    <strong class="row-subtotal">Bs. <?php echo e(number_format($detail->subtotal, 2)); ?></strong>
                                </td>
                                <td class="align-middle">
                                    <?php if($order->status === 'pending'): ?>
                                        <input type="text" class="form-control form-control-sm note-input"
                                               value="<?php echo e($detail->notes); ?>" data-item-key="detail-<?php echo e($detail->id); ?>">
                                    <?php else: ?>
                                        <span class="text-muted"><?php echo e($detail->notes ?? '-'); ?></span>
                                    <?php endif; ?>
                                </td>
                                <?php if($order->status === 'pending'): ?>
                                <td class="text-end align-middle">
    ...
    <div class="col-lg-4">
        <?php if(!empty($auditEntries) && $auditEntries->count() > 0): ?>
        <div class="card mb-4">
            <div class="card-header">
                    ...
                    <?php $__currentLoopData = $auditEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="audit-entry">
                            <div class="d-flex justify-content-between gap-3">
                                ...
                                <small class="text-muted"><?php echo e($entry['date']); ?></small>
                            </div>
                            <div class="text-muted small">
                                <?php echo e($entry['user']); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <span>Subtotal:</span>
                    <strong id="summarySubtotal">Bs. <?php echo e(number_format($order->subtotal, 2)); ?></strong>
                </div>
                <hr>
                <div class="d-flex justify-content-between mb-4">
                    <h5><strong>Total:</strong></h5>
                    <h4><strong class="text-success" id="summaryTotal">Bs. <?php echo e(number_format($order->total, 2)); ?></strong></h4>
                </div>

                <?php if($order->status === 'pending'): ?>
                <form action="<?php echo e(route('cashier.process-order', $order->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                ...
                <form action="<?php echo e(route('cashier.cancel-order', $order->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mb-3 small">
                    <div><strong>Metodo de pago:</strong> <?php echo e($order->payment_method === 'cash' ? 'Efectivo' : ($order->payment_method === 'mixed' ? 'Efectivo + QR' : 'QR')); ?></div>
                    <?php if($order->payment_method === 'cash'): ?>
                        <div><strong>Efectivo:</strong> Bs. <?php echo e(number_format($order->cash_paid_amount ?? $order->total ?? 0, 2)); ?></div>
                    <?php elseif($order->payment_method === 'qr'): ?>
                        <div><strong>QR:</strong> Bs. <?php echo e(number_format($order->qr_paid_amount ?? $order->total ?? 0, 2)); ?></div>
                    <?php elseif($order->payment_method === 'mixed'): ?>
                        <div><strong>Efectivo:</strong> Bs. <?php echo e(number_format($order->cash_paid_amount ?? 0, 2)); ?></div>
                        <div><strong>QR:</strong> Bs. <?php echo e(number_format($order->qr_paid_amount ?? 0, 2)); ?></div>
                    <?php endif; ?>
                </div>
                ...
                <form action="<?php echo e(route('cashier.revert-order', $order->id)); ?>" method="POST" class="mt-2">
                    <?php echo csrf_field(); ?>
                    <div class="mb-2">
...
$('#saveOrderChanges').on('click', function() {
    $.ajax({
        url: '<?php echo e(route("cashier.update-order-items", $order->id)); ?>',
        method: 'POST',
        data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/cevicheria-pos/resources/views/cashier/order-detail.blade.php ENDPATH**/ ?>