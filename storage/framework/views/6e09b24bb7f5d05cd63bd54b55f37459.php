                ...
                <form action="<?php echo e(route('admin.users.store')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" class="form-select" id="roleSelect" required>
                            ...
                            <option value="cajero" <?php echo e(old('role') === 'cajero' ? 'selected' : ''); ?>>Cajero</option>
                            <option value="mesero" <?php echo e(old('role') === 'mesero' ? 'selected' : ''); ?>>Mesero</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3" id="orderChannelGroup" style="display:none;">
                        ...
                        <select name="order_channel" class="form-select">
                            <option value="table" <?php echo e(old('order_channel', 'table') === 'table' ? 'selected' : ''); ?>>Atención en mesa</option>
                            <option value="delivery" <?php echo e(old('order_channel') === 'delivery' ? 'selected' : ''); ?>>Delivery</option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/cevicheria-pos/resources/views/admin/users/create.blade.php ENDPATH**/ ?>