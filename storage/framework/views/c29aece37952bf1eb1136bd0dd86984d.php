...
<body>
    ...
    <div class="stats">
        <div class="stat">
            ...
            <div class="value">Bs. <?php echo e(number_format($beverageSummary['total_revenue'], 2)); ?></div>
        </div>
        <div class="stat">
            <div class="label">Compra Estimada</div>
            <div class="value">Bs. <?php echo e(number_format($beverageSummary['estimated_cost'], 2)); ?></div>
        </div>
        <div class="stat">
            <div class="label">Ganancia</div>
            <div class="value">Bs. <?php echo e(number_format($beverageSummary['estimated_profit'], 2)); ?></div>
        </div>
        <div class="stat">
            <div class="label">Unidades Vendidas</div>
            <div class="value"><?php echo e($beverageSummary['total_units_sold']); ?></div>
        </div>
    </div>

    <?php if($beverageSummary['missing_cost_products'] > 0): ?>
        <div class="note">
            Hay <?php echo e($beverageSummary['missing_cost_products']); ?> producto(s) y <?php echo e($beverageSummary['missing_cost_units']); ?> unidad(es) sin compra registrada. En esos casos no se calcula ganancia.
        </div>
    <?php endif; ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $beverageProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="center"><?php echo e($item->units_sold); ?></td>
                    <td class="right">Bs. <?php echo e(number_format($item->average_sale_price, 2)); ?></td>
                    <td class="right">
                    ...
                    <td class="right">Bs. <?php echo e(number_format($item->revenue, 2)); ?></td>
                    <td class="right">
                        <?php if($item->has_cost_data): ?>
                    ...
                    <td class="right">
                        <?php if($item->has_cost_data): ?>
                            <span class="<?php echo e($item->gross_profit >= 0 ? 'success' : 'danger'); ?>">
...
<?php /**PATH /var/www/html/cevicheria-pos/resources/views/admin/reports-beverages-gain-print.blade.php ENDPATH**/ ?>